...
const MFA_PROMPT = [
  ...
  '  opaque string Alarm.com leaves in your browser after you complete',
  '  two-factor verification.',
  '',
  '  Tick "remember"/"trust this device" when you sign in. Alarm.com sets the',
  '  cookie either way, but an untrusted one works only in the browser that',
  '  made it, and this script gets a 409. Trust the browser you copy FROM;',
  '  the machine you replay on does not need to be trusted.',
  '',
