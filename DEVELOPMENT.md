...
- **Dev-dependency hygiene.** An `overrides` entry pins transitive `js-yaml` to `3.15.1` (GHSA-5p4m-2wfm-xmqj on 3.x via Jest coverage). It is dev-only and never shipped.
